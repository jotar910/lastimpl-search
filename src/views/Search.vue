<template>
  ...
  <form class="search container m-auto flex items-center px-8 py-4 md:px-10 md:py-5">
  ...
  <hr/>
  <section v-if="!querying && list" class="container m-auto px-8 py-4 md:px-10 md:py-5">
...
export default class Search extends Vue {
  ...
  async search(query: string | undefined): Promise<unknown> {
    if (!query) {
